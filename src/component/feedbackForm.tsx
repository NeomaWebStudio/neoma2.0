...
const FeedbackForm = ({ translations }: TranslationProps) => {
	...
	return (
		<div className='mt-12 w-full  text-white h-[590] fidback-form-main-div'>	
			<div className='text-center'>
				<h3 className='font-nunito text-5xl text-white flex justify-center items-center mb-10'>{translations['contacts']}</h3>
			</div>
			<div className="flex justify-center gap-6 w-full">
				...
				<div className="flex justify-center items-center w-[418px] h-[414px]">
				...
				<div className="flex flex-col w-[416px] h-[408px] gap-4">
					<p>{translations["contacts_text_2"]}</p>
