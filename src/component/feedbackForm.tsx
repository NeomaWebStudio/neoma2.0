...
const FeedbackForm = ({ translations }: TranslationProps) => {
  ...
  return (
    <div id='contact' className='w-full text-white mb-24'>
      <h2 className='font-nunito text-[28px] md:text-5xl text-white text-center mb-12'>
        {translations['contacts']}
      </h2>

      <div className='feedback_form-container'>
        <div className='flex flex-col gap-3' style={{ gridArea: 'socials' }}>
          <h4 className='text-4 text-white'>
            {translations['contacts_text_1']}
          </h4>
          <div className='flex flex-col'>
            ...
            >
              ...
              >
                ...
                />
                <path
                  d='M2.5 17V7C2.5 5.89543 3.39543 5 4.5 5H20.5C21.6046 5 22.5 5.89543 22.5 7V17C22.5 18.1046 21.6046 19 20.5 19H4.5C3.39543 19 2.5 18.1046 2.5 17Z'
                  stroke='currentColor'
                  strokeWidth='1.5'
                />
              </svg>
        ...
        <div className='flex flex-col gap-4' style={{ gridArea: 'inputs' }}>
          ...
          >
            <div
              className='flex items-center w-full border border-orange-500 rounded-full px-4 py-3 bg-[#0A081A]
            ...
            >
              <svg
                ...
                className={`w-5 h-5 mr-3 transition-colors duration-300 ${
                  name ? 'text-orange-400' : 'text-white'
                }`}
                width='24'
                height='24'
                viewBox='0 0 24 24'
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  const result = contactSchema.shape.name.safeParse(
                    e.target.value
                  )
                  if (!result.success) {
                    setErrors((prev) => ({
          ...
          {errors.name && (
            <p className='text-red-500 text-[14px]'>{errors.name[0].message}</p>
          )}
          ...
          >
            ...
            >
              ...
              <svg
                ...
                xmlns='http://www.w3.org/2000/svg'
                className={`w-5 h-5 mr-3 transition-colors duration-300 ${
                  phone ? 'text-orange-400' : 'text-white'
                }`}
              >
                <path
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  const result = contactSchema.shape.phone.safeParse(
                    e.target.value
                  )
                  if (!result.success) {
                    setErrors((prev) => ({
                      ...prev,
                      phone: result.error.issues,
                    }))
                  } else {
          ...
          >
            ...
            >
              <svg
                ...
                height='24'
                className={`w-5 h-5 mr-3 transition-colors duration-300 ${
                  email ? 'text-orange-400' : 'text-white'
                }`}
                viewBox='0 0 24 24'
                fill='none'
                xmlns='http://www.w3.org/2000/svg'
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  const result = contactSchema.shape.email.safeParse(
                    e.target.value
                  )
                  if (!result.success) {
                    setErrors((prev) => ({
          ...
          >
            <div
              className='flex items-center w-full border border-orange-500 px-4 py-3 bg-[#0A081A]
							focus-within:border-transparent
							hover:border-[#FFC08F]
							focus-within:[&>svg]:text-[#FFC08F]
            ...
            >
              <textarea
                ...
                onChange={(e) => {
                  ...
                  const result = contactSchema.shape.description.safeParse(
                    e.target.value
                  )
                  if (!result.success) {
                    setErrors((prev) => ({
        ...
        <div className='' style={{ gridArea: 'spline' }}>
          <Spline
            scene='/robot_camerax2.splinecode'
