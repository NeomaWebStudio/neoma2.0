...
const FeedbackForm = () => {
	...
	return (
		<div className='w-full text-white mb-24'>
			<h2 className='font-nunito text-[28px] md:text-5xl text-white text-center mb-12'>Контакти</h2>
			...
			<div className="feedback_form-container">
				...
				<div className="" style={{ gridArea: "spline" }}>
					<Spline scene="/cursor.splinecode" className='flex justify-center items-center' />
				</div>
			</div>
		</div>
	);
