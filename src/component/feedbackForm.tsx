...
const FeedbackForm = () => {
			...
			<div className="flex justify-center gap-6 w-full">
				<div className="flex flex-col gap-3 w-[315px]">
					...
					<div className='flex flex-col w-[315px] h-[280px] gap-2 left-0 relative'>
						<a href="#"
							className="flex py-2 px-4 gap-1
										text-[#FFA157]
										hover:text-[#FFC08F]
										active:text-[#CC8146]
										[&>svg]:stroke-current
						...
						<a href='#' className='flex py-2 px-4 gap-1
										text-[#FFA157]
										hover:text-[#FFC08F]
										active:text-[#CC8146]
										[&>svg]:stroke-current
										...
										transition-colors duration-150'>
											<svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M7.5 9L12.5 12.5L17.5 9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
												<path d="M2.5 17V7C2.5 5.89543 3.39543 5 4.5 5H20.5C21.6046 5 22.5 5.89543 22.5 7V17C22.5 18.1046 21.6046 19 20.5 19H4.5C3.39543 19 2.5 18.1046 2.5 17Z" stroke="currentColor" stroke-width="1.5"/>
											</svg>
											neomawebstudio@gmail.com
						</a>
						<a href='#' className='flex py-2 px-4 gap-1
										text-[#FFA157]
										hover:text-[#FFC08F]
				...
				<div className="flex flex-col w-[416px] h-[408px] gap-4">
					...
					<div className="relative w-full max-w-md rounded-full transition-all duration-300
					...
					<div className="relative w-full max-w-md transition-all duration-300
					  ...
					  <div className="flex items-center w-full border border-orange-500 px-4 py-3 bg-[#05040d]
					      ...
					      hover:[&>svg]:text-[#FFC08F] transition-all duration-300 rounded-3xl">
							<textarea name="" id="" placeholder='Коротко опишіть свій сайт запит' className='resize-none w-full h-[120px] 
  ...
  className="
    ...
    rounded-3xl w-full h-[40px] leading-[40px]
    cursor-pointer
