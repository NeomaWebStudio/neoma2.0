  ...
  return (
    <>
      <div className="flex flex-row items-center justify-between h-22 text-white sticky font-kurale" >
        ...
        >
          <button className=" text-black bg-[#FFA157] cursor-pointer w-49 h-10 rounded-[24px] text-center 
      ...
      {/* Side Menu */}
      <div className={`fixed top-0 left-0 h-full w-85 bg-[#05040D] z-50 transform transition-transform duration-300 ease-in-out ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'
        }`}>
