...
const Nav = ({ translations }: TranslationProps) => {
  ...
  return (
    <>
      ...
      {/* Side Menu */}
      <div className={`fixed top-0 left-0 h-full w-85 bg-[#05040D] z-50 transform transition-transform duration-300 ease-in-out ${true ? 'translate-x-0' : '-translate-x-full'
        }`}>
