...
export default function Faq({ translations }: TranslationProps) {
  const items = [
    {
      q: translations["faq_q1"],
      a: {
        text: translations["faq_a1"],
        list: [
  ...
  w-full max-w-[600px] break-words overflow-x-hidden"
            >
              ...
              <div
                className={`text-[16px] mt-4 overflow-hidden transition-all duration-300 ease-in-out break-words whitespace-normal overflow-x-hidden ${openIndex === idx ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"
                  }`}
              >
