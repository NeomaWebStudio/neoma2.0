		...
		<div className='xl:h-screen mb-24'>
			...
			<div className='flex gap-6 mt-12 xl:mt-40'>
				<div className='md:w-[55%] aos-desktop-only'
					...
					<h1 className='text-[38px] leading-[1.2] xl:text-[64px] tracking-[0.03em] xl:leading-[68px] text-white'>{translations['main_block_title']}</h1>
					<p className='text-[20px] leading-normal xl:text-[32px] xl:leading-[38px] tracking-0 text-white mt-4'>{translations['main_block_description']}</p>
             ...
             transition-shadow duration-300 ease-in-out bg-[#FFA157]'>{translations['contact_btn']}</button>
				...
				<div className="hidden md:flex md:justify-center w-[45%] aos-desktop-only h-[500px] relative"
